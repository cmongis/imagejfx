 ...
 * - save and load from\to text file in TSIN format. 
 ...
 * For the original applet see: http://www.pi6.fernuni-hagen.de/GeomLab/VoroGlide/ . 
 */
...
public class Delaunay_Triangulation {
	 ...
	 * 
	 * Implementation of the Mostafavia, Gold and Dakowicz algorithm (2002).
	 * 
	 * By Eyal Roth and Doron Ganel (2009).
	 */
	 ...
	 *         triangulation).
	 */
	public Double zDouble(double x, double y) {
		Point_dt q = new Point_dt(x, y);
		Triangle_dt t = find(q);
		
		return t.z_valueDouble(q);
	}
