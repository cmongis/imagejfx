...
public class DatasetSamplerService extends AbstractService implements IjfxService{
    ...
    public Dataset isolateDimension(Dataset dataset, AxisType axes, long dimension) {
        
        
        SamplingDefinition def = new SamplingDefinition(dataset);
        
        def.constrain(axes, new AxisSubrange(dimension));
    ...
    public Dataset duplicateDate(Dataset dataset, SamplingDefinition def) {
