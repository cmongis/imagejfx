...
@UiConfiguration(id = "imagej-top-toolbar", context = "imagej+image-open segment+image-open imagej+table-open imagej+image-open imagej+measure-open segment+measure-open", order = 13.0, localization = Localization.TOP_TOOLBAR)
