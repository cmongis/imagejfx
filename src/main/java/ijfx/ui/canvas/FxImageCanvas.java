 ...
 * The FxImageCanvas.
 * 
 * This canvas offer built-in image moving and zooming. The canvas
 * uses the a virtual camera to calculate which part of the image
 * should be displayed. The center can be moved, refreshing
 * the display. The zoom level can also be adjusted. However
 * to move the image, you will need to apply a FxHand.
 * 
...
public class FxImageCanvas extends Canvas {
    ...
    /**
     *  Draw the borders when the size of the displayed image is smaller
     *  than the screen
     */
    protected void drawBorders() {
        ...
        if(borderHeight == 0 && borderWidth == 0) return;
